...
function App() {
  ...
  const addUser = (e) => {
    ...
    setUsers([...users, { id: Date.now(), names, ages }]);
    setNames(""); 
    setAges(""); 
  };
  ...
  return (
    <>
      ...
      <form onSubmit={addUser}>
        ...
        <input type="text" placeholder="이름" value={names} onChange={(e) => setNames(e.target.value)}/>
        <input type="number" placeholder="나이" value={ages} onChange={(e) => setAges(e.target.value)} />
